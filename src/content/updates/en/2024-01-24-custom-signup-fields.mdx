...
ogImage: 2024-01-24-custom-fields.png
---

**You can now add custom fields to your newsletter signup forms.**

<KeilaImage
  src="/src/assets/updates/2024-01-24-custom-fields.png"
  alt="Screenshot showing a newsletter signup field created with Keila featuring a custom text field, a custom dropdown field, and a custom tags field."
></KeilaImage>
