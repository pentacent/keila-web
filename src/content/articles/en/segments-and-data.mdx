...
You can also create segments based on campaign interactions. For example, to target all contacts who received but haven't opened a specific campaign:
...
<I18NLink collection="docs" i18nId="segments" lang="en">Read more about the Keila Query Language in the docs.</I18NLink>
