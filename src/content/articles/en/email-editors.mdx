...
## Full customization with MJML

If you want full control over your newsletter design, you can use
[MJML](https://mjml.io/) to build your newsletters. This allows you
to customize every aspect of the newsletter design while still
maintaining excellent compatibility with mobile devices and legacy
desktop clients.

<KeilaImage
  src="/src/assets/updates/2024-08-21-mjml.png"
  alt="Screenshot of the Keila MJML editor"
/>
