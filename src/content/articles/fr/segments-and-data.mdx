...
Vous pouvez également créer des segments basés sur les interactions avec les campagnes. Par exemple, pour cibler tous les contacts qui ont reçu mais n'ont pas ouvert une campagne spécifique :
